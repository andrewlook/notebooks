...
# SLML Part 1 - Assembling the Dataset

> _This post is part 1 of ["SLML" - Single-Line Machine Learning](/projects/slml.qmd)._
> 
> _Check out the previous post, [part 0](./slml_part0.qmd), for some background on why I got started training SketchRNN on my own drawings._
>
> _Next in the series is [part 2](./slml_part2.qmd), where I convert my JPEGs into stroke-3 format in preparation for model training._

For years, I've maintained a [daily practice](./slml_background.qmd) of making single-line drawings in my sketchbooks. 
...
> _Next in my [SLML](/projects/slml.qmd) series is [part 2](./slml_part2.qmd), where I convert my JPEGs into stroke-3 format in preparation for model training._