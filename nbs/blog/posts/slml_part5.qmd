...
:::{#fig-bbox-1 .column-body-outset layout-ncol=3}
...
:::{#fig-bbox-1 .column-body-outset layout-ncol=4}
...
Once I have all the separated strokes, I save into a dataset as separate drawings.  
...
I hypothesize that the bbox-separated dataset will be a big improvement because of the consistency of the resulting drawings. Before, the model was learning that sometimes drawings end after one person is drawn, but sometimes we move the pen and start a new person.

:::{#fig-bbox-split-example .column-page layout-ncol=4}
![Original](https://i.ibb.co/SrpsMWZ/bbox-20.png)

![](https://i.ibb.co/PNLqQLG/bbox-21.png)

![](https://i.ibb.co/wWKK6zC/bbox-22.png)

![](https://i.ibb.co/N18YMC0/bbox-23.png)
...
![dataset-comparison-with-v2-splicedata](https://i.ibb.co/vvMWrDc/dataset-comparison-with-v2-splicedata.png) 

Comparison of previous dataset `v2-splicedata` with `20231214` and `20231214-filtered`.
:::

Since pages containing multiple distinct drawings were divided into separate rows in the new training set, the dataset grew dramatically. While the previous dataset `v2-splicedata` only has 1200 drawings, the new bounding-box separated dataset `20231214` has 2400 drawings.
...
:::{#fig-under50 .column-body-outset layout-ncol=3}
...
:::{#fig-gen-bbox1 .column-page layout-ncol=3}
...
:::{#fig-gen-bbox2 .column-page layout-ncol=4}
