---
title: SLML Part 0 - Why I Decided to Train SketchRNN on My Drawings
...
# SLML Part 0 - Why I Decided to Train SketchRNN on My Drawings

> _This post is part 0 of ["SLML" - Single-Line Machine Learning](/projects/slml.qmd)._
> 
> _If you want some context on how I got into single-line drawings, check out the [background section](./slml_background.qmd)._
> 
> _Next in the series is [part 1](./slml_part1.qmd) where I assemble the training data, and filter it using visual embeddings._
...
> _Next in my [SLML](/projects/slml.qmd) series is [part 1](./slml_part1.qmd), where I convert my JPEG scans into vector representations in preparation for training SketchRNN._