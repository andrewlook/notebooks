...
> 
> _To read the previous post, check out [part 1](./slml_part1.qmd). If you want to keep reading, here is [part 3](./slml_part3.qmd)._
...
> _If you want to keep reading, here is [part 3](./slml_part3.qmd) of my [SLML](/projects/slml.qmd) series._